...
\newenvironment{crypto}{\begin{framed}
%\vspace{-18pt}
\begin{wrapfigure}{l}{0.15\textwidth}
\vspace{-12pt}\quad{
\begin{tikzpicture}[scale=0.4]
\draw[fill] (0, 0) -- (2, 0) [rounded corners] -- (2, -2)  -- (0, -2) -- (0, 0);
\draw[line width=4pt] (0.5, 0) 
.. controls (0.5, 1) and (0.5, 1) .. (1, 1)
.. controls (1.5, 1) and (1.5, 1) .. (1.5, 0);
\draw[fill=white] (1, -0.75) circle[radius=0.35];
\path[fill=white] (0.9, -0.8) -- (0.8, -1.6) -- (1.2, -1.6) -- (1.1, -0.8);
\end{tikzpicture}
}
\end{wrapfigure}}{\end{framed}}
...
scheme are marked with a \Sun\ symbol. Sections relating to cryptographic
building blocks are marked with a padlock symbol.
